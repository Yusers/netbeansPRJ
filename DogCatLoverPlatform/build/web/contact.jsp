...
<html>
    ...
    <div class="container-fluid pt-5">
        <div class="d-flex flex-column text-center mb-5 pt-5">
            ...
            <h1 class="display-5 m-0">Please complete request<span class="text-primary">.We will assist you as soon as possible.</span></h1>
        </div>
            ...
            <div class="col-12 col-sm-8 mb-5">
                <div class="contact-form">
                    ...
                    <form name="sentMessage" id="contactForm" novalidate="novalidate">
                        ...
                        <div class="control-group">
                            <input type="text" class="form-control p-4" id="phone" placeholder="Contact Number" required="" data-validation-required-message="Please enter your phone number" />
                            <p class="help-block text-danger"></p>
                        </div>
                        <div class="control-group">
