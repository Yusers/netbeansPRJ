...
public class FindServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            ArrayList<Car> listC = CarDao.getCars(name);
            
            // De tang trai nghiem cho user, tao 1 cookie chua keyword user tim de hien thi 
            // san pham tuong dong sau nay
            Cookie cookie = new Cookie("wishlist", name);
